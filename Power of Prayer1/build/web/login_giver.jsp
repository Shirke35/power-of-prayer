...
.login .details .signup {
  ...
  <div class="details">
    ...
    <form action="Login_Giver1" method="Post">
    ...
    <div class="input">
      <label for="">Password
      </label><input type="text" name="password" placeholder="Enter your password" required>
    </div>
    <button class="login-button">Log in</button>
      ...
      I'am new here&nbsp; <a href="register_giver.jsp">Register</a>
  </div>
</div>
</form>
</body>
