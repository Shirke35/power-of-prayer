<%-- 
    Document   : Logindashboard_taker
    Created on : Oct 5, 2021, 11:25:06 AM
    Author     : SANIKA
--%>
...
<body>
	...
	<div class="inner_block">
		<img class="bgpic" src="bgpic.jpg">
		<p class="sub_heading">Power of Prayer</p>
		<p class="quote">Prayers are magic that works in a way that we don't understand</p>
                <a href="login_taker.jsp">
                <button class="button-65" role="button">Login</button>
                </a>
                <a href="register_taker.jsp">
                <button class="button-65 two" role="button">Register</button>
                </a>
	</div>
    <%
    try{
	...
	<div class="card blk1">
		  <img src="img_avatar.png" alt="Avatar" style="width:100%">
			<div class="container">
			    ...
			    <button class="button-70 but1" role="button">Giver Prayer</button>
  			</div>
  	</div>
